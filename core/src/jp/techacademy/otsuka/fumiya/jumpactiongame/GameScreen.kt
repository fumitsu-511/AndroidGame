...
class GameScreen(private val mGame: JumpActionGame):ScreenAdapter() {
    ...
    private val sound = Gdx.audio.newSound(Gdx.files.internal("enemy.mp3"))
    ...
    init {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.otsuka.fumiya.jumpactiongame")
    ...
    private fun createStage() {
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            if (mRandom.nextFloat() > 0.5f){
                ...
                enemy.setPosition(mRandom.nextFloat() * (WORLD_WIDTH - step.x), step.y + Enemy.ENEMY_HEIGHT + mRandom.nextFloat() * 3 )
                mEnemy.add(enemy)
            }
